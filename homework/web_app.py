...
# Siempre se debe crear esta inicializacion de la aplicacion
app = Flask(__name__)
app.config["SECRET_KEY"] = "you-will-never-guess"

@app.route("/", methods=["GET", "POST"])

# Esta linea de comando permite que cada vez que se acceda al index de la pagina, se ejecute la funcion index()
